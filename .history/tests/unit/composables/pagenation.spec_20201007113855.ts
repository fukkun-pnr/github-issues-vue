...
describe('composables/pagenation',() => {
    ...
    it("setPagenation: change size", () => {
        ...
        const { pagenation2, setPagenation2 } = usePagenation(3);
        setPagenation2(1, 15);
        expect(pagenation2.value.start).toStrictEqual([1, 2]);
        expect(pagenation2.value.center).toStrictEqual([5, 6, 7]);
        expect(pagenation2.value.end).toStrictEqual([14, 15]);
