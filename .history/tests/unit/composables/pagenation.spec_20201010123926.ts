...
describe('composables/pagenation', () => {
    it("setPagenation: normal", () => {
        ...
        expect(pagenation.value.isStartDot).toBe(false);
        expect(pagenation.value.isEndDot).toBe(true);
        ...
        expect(pagenation.value.isNext).toBe(true);
        expect(pagenation.value.isStartDot).toBe(true);
        expect(pagenation.value.isEndDot).toBe(false);
        expect(pagenation.value.start).toStrictEqual([1, 2]);
